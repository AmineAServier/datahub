...
import com.github.servier.datahub.graph.util.{DfsUtils, FileTransferOptions}
  ...
  ignore("niouk3") {
    val params: Map[String, String] =
      Map(
        ...
        "resource" -> "00000003-0000-0ff1-ce00-000000000000/infinity2568.graph.com@eed4540e-335e-4540-954e-6c039c21893b",
        ...
        "fileFormat" -> "csv",
        "inferSchema" -> "false",
        "url" -> "https://infinity2568.graph.com/sites/test/",
